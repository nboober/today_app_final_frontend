...
class OutfitContainer extends React.Component{
    ...
    render(){
        ...
        return(
            <Link to="/outfitshow" onClick={() => this.props.selectedOutfit(this.props.hats, this.props.jewelry, this.props.jackets, this.props.shirts, this.props.belts,this.props.pants, this.props.shoes)}>
